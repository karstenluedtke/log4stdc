...
int main()
{
    ...
    test(S(L"12345678901234567890"), s, s+1, S(L"12345678901234567890""A"));
    test(S(L"12345678901234567890"), s, s+10, S(L"12345678901234567890""ABCDEFGHIJ"));
    test(S(L"12345678901234567890"), s, s+52,
         S(L"12345678901234567890""ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"));
