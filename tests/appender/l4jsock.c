...
static const char refstream[] = {
    ...
    'u', 'i', 'r', 'e', 'd', 'Z', 0x00, 0x11, 'n', 'd', 'c', 'L', 'o', 'o', 'k',
    'u', 'p', 'R', 'e', 'q', 'u', 'i', 'r', 'e', 'd', 'J', 0x00, 0x09, 't', 'i',
    'm', 'e', 'S', 't', 'a', 'm', 'p', 'L', 0x00, 0x0C, 'c', 'a', 't', 'e', 'g',
    'o', 'r', 'y', 'N', 'a', 'm', 'e', 't', 0x00, 0x12, 'L', 'j', 'a', 'v', 'a',
    '/', 'l', 'a', 'n', 'g', '/', 'S', 't', 'r', 'i', 'n', 'g', ';', 'L', 0x00,
    0x0C, 'l', 'o', 'c', 'a', 't', 'i', 'o', 'n', 'I', 'n', 'f', 'o', 't', 0x00,
    '#', 'L', 'o', 'r', 'g', '/', 'a', 'p', 'a', 'c', 'h', 'e', '/', 'l', 'o',
    'g', '4', 'j', '/', 's', 'p', 'i', '/', 'L', 'o', 'c', 'a', 't', 'i', 'o',
    'n', 'I', 'n', 'f', 'o', ';', 'L', 0x00, 0x07, 'm', 'd', 'c', 'C', 'o', 'p',
    'y', 't', 0x00, 0x15, 'L', 'j', 'a', 'v', 'a', '/', 'u', 't', 'i', 'l', '/',
    'H', 'a', 's', 'h', 't', 'a', 'b', 'l', 'e', ';', 'L', 0x00, 0x03, 'n', 'd',
    'c', 't', 0x00, 0x12, 'L', 'j', 'a', 'v', 'a', '/', 'l', 'a', 'n', 'g', '/',
    'S', 't', 'r', 'i', 'n', 'g', ';', 'L', 0x00, 0x0F, 'r', 'e', 'n', 'd', 'e',
    'r', 'e', 'd', 'M', 'e', 's', 's', 'a', 'g', 'e', 't', 0x00, 0x12, 'L', 'j',
    'a', 'v', 'a', '/', 'l', 'a', 'n', 'g', '/', 'S', 't', 'r', 'i', 'n', 'g',
    ';', 'L', 0x00, 0x0A, 't', 'h', 'r', 'e', 'a', 'd', 'N', 'a', 'm', 'e', 't',
    0x00, 0x12, 'L', 'j', 'a', 'v', 'a', '/', 'l', 'a', 'n', 'g', '/', 'S', 't',
    'r', 'i', 'n', 'g', ';', 'L', 0x00, 0x0D, 't', 'h', 'r', 'o', 'w', 'a', 'b',
    'l', 'e', 'I', 'n', 'f', 'o', 't', 0x00, '+', 'L', 'o', 'r', 'g', '/', 'a',
    'p', 'a', 'c', 'h', 'e', '/', 'l', 'o', 'g', '4', 'j', '/', 's', 'p', 'i',
    '/', 'T', 'h', 'r', 'o', 'w', 'a', 'b', 'l', 'e', 'I', 'n', 'f', 'o', 'r',
    'm', 'a', 't', 'i', 'o', 'n', ';', 'x', 'p', 0x00, /* mdc lookup required */
    0x00,                                              /* ndc lookup required */
    '?', '?', '?', '?', '?', '?', '?',
    '?', /* timestamp 0x00,0x00,0x01,'S',0xAD,0xAD,'O',0xD2, */
    't', 0x00, 0x0A, 't', 'e', 's', 't', 'l', 'o', 'g', 'g', 'e', 'r', 's', 'r',
    0x00, '!', 'o', 'r', 'g', '.', 'a', 'p', 'a', 'c', 'h', 'e', '.', 'l', 'o',
    'g', '4', 'j', '.', 's', 'p', 'i', '.', 'L', 'o', 'c', 'a', 't', 'i', 'o',
    'n', 'I', 'n', 'f', 'o', 0xED, 0x99, 0xBB, 0xE1, 'J', 0x91, 0xA5, '|', 0x02,
    0x00, 0x01, 'L', 0x00, 0x08, 'f', 'u', 'l', 'l', 'I', 'n', 'f', 'o', 't',
    0x00, 0x12, 'L', 'j', 'a', 'v', 'a', '/', 'l', 'a', 'n', 'g', '/', 'S', 't',
    'r', 'i', 'n', 'g', ';', 'x', 'p', 't', 0x00, 0x1D, '.', 't', 'e', 's', 't',
    'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', '(', 's', 'o', 'u', 'r', 'c', 'e',
    'f', 'i', 'l', 'e', ':', '1', '0', '0', ')', 'p', 'p', 't', 0x00, 0x03, 'A',
    'B', 'C', 't', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?',
    '?', '?', '?', '?',
    ...
    't', 0x00, 0x0A, 't', 'e', 's', 't', 'l', 'o', 'g', 'g', 'e', 'r', 's', 'q',
    0x00, 0x7E, 0x00, 0x0A, 't', 0x00, 0x1D, '.', 't', 'e', 's', 't', 'f', 'u',
    'n', 'c', 't', 'i', 'o', 'n', '(', 's', 'o', 'u', 'r', 'c', 'e', 'f', 'i',
    'l', 'e', ':', '1', '0', '1', ')', 'p', 'p', 't', 0x00, 0x03, 'D', 'E', 'F',
    't', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?',
    '?', '?',
    /* threadid '0','x','7','f','d','3','9','8','e','f','5','7','8','0',*/
    'p', 'w', 0x04, 0x00, 0x00, 0x4E, 0x20, /* level */
