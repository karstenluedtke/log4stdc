...
void test0()
{
    ...
    test(S(L"qanej"), S(L"dfkap"), 0, 1);
    test(S(L"clbao"), S(L"ihqrfebgad"), 0, 2);
    ...
    test(S(L"gfshlcmdjr"), S(L"nadkh"), 1, 3);
    ...
    test(S(L"drtasbgmfp"), S(L"ktsrmnqagd"), 9, S::npos);
    ...
    test(S(L"aemtbrgcklhndjisfpoq"), S(L"lbtqd"), 0, 3);
    ...
    test(S(L"lhosrngtmfjikbqpcade"), S(L"aqibs"), 1, 3);
    ...
    test(S(L"copqdhstbingamjfkler"), S(L"djkqc"), 19, S::npos);
...
void test1()
{
    ...
    test(S(L"gmfhd"), S(L"kantesmpgj"), 0);
    test(S(L"odaft"), S(L"oknlrstdpiqmjbaghcfe"), 0);
    test(S(L"eolhfgpjqk"), S(L""), S::npos);
    test(S(L"nbatdlmekr"), S(L"bnrpe"), 0);
    test(S(L"jdmciepkaq"), S(L"jtdaefblso"), 0);
    test(S(L"hkbgspoflt"), S(L"oselktgbcapndfjihrmq"), 0);
    test(S(L"gprdcokbnjhlsfmtieqa"), S(L""), S::npos);
    test(S(L"qjghlnftcaismkropdeb"), S(L"bjaht"), 1);
    test(S(L"pnalfrdtkqcmojiesbhg"), S(L"hjlcmgpket"), 0);
    test(S(L"pniotcfrhqsmgdkjbael"), S(L"htaobedqikfplcgjsmrn"), 0);
}
