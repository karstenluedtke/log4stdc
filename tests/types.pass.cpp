...
test()
{
    typedef barefootc::basic_string<typename Traits::char_type, Traits, Allocator> S;
...
int main()
{
    ...
    static_assert((std::is_same<barefootc::basic_string<char>::traits_type,
                                std::char_traits<char> >::value), "");
    static_assert((std::is_same<barefootc::basic_string<char>::allocator_type,
