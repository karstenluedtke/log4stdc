...
int main()
{
    ...
    test(S(L"12345"), L"", S());
    test(S(L"12345"), L"12345", S(L"12345"));
    test(S(L"12345"), L"1234567890", S(L"1234567890"));

    test(S(L"12345678901234567890"), L"", S());
    test(S(L"12345678901234567890"), L"12345", S(L"12345"));
