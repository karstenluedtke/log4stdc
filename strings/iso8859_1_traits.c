...
char	bfc_unicode_to_iso8859_1(int c);
int	bfc_iso8859_1_to_unicode(char c);
...
const struct char_traits_class bfc_iso8859_1_traits_class = {
	.super	= NULL,
	.name	= "char_traits",
	.eq	= bfc_char_eq,
	.lt	= bfc_char_lt,
	...
	.to_char= bfc_unicode_to_iso8859_1,
	.to_int	= bfc_iso8859_1_to_unicode,
	.eq_int = bfc_char_eq_int,
};

unsigned short iso8859_1_0xA0_0xBF_unicodes[32] = {
...
int
bfc_iso8859_1_to_unicode(char c)
{
...
char
bfc_unicode_to_iso8859_1(int c)
{
	if ((c & ~0xFF) == 0) {
		return ((char) c);
	}
