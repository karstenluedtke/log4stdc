...
extern struct bfc_classhdr bfc_cp1250_traits_class;
...
struct bfc_string_class bfc_shared_cp1250_string_class = {
	.super 		= &bfc_shared_string_class,
	.name 		= "shared_cp1250_string",
	.init 		= bfc_init_empty_cp1250_string,
	...
	.traits		= (void *) &bfc_cp1250_traits_class,

	.substr		= bfc_shared_cp1250_substr,
	.mutable_substr	= mutable_substr,
	.buffered_substr= bfc_buffered_cp1250_substr,
};

struct bfc_string_class bfc_buffered_cp1250_string_class = {
	.super 		= &bfc_string_class,
	.name 		= "buffered_cp1250_string",
	.init 		= bfc_init_empty_cp1250_string,
...
int
bfc_init_shared_cp1250_string(void *buf, size_t bufsize,
...
int
bfc_init_shared_cp1250_string_c_str(void *buf,size_t bufsize,const char *s)
{
	int n;
	l4sc_logger_ptr_t logger = l4sc_get_logger(BFC_STRING_LOGGER);
	...
	n = (*bfc_shared_cp1250_string_class.traits->szlen)(s);
	return bfc_init_shared_cp1250_string(buf, bufsize, s, n);
}

int
bfc_init_buffered_cp1250_string(void *buf, size_t bufsize,
				    const char *s, size_t n)
{
	l4sc_logger_ptr_t logger = l4sc_get_logger(BFC_STRING_LOGGER);
						...
						void *buf, size_t bufsize)
{
	...
	return (bfc_init_shared_cp1250_string(buf, bufsize, data, sublen));
}
...
mutable_substr(bfc_cstrptr_t s, size_t pos, size_t n, void *buf, size_t bufsize)
{
	...
	bfc_init_shared_cp1250_string(buf, bufsize, data, sublen);
	return (-ENOSYS);
}
