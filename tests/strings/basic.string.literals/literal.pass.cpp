...
int main()
{
    ...
    static_assert ( std::is_same<decltype(   "Hi"s), barefootc::basic_string<char>>::value, "" );
    static_assert ( std::is_same<decltype( u8"Hi"s), barefootc::basic_string<char>>::value, "" );
    ...
    barefootc::basic_string<char> foo;
    std::wstring Lfoo;
    std::u16string ufoo;
    std::u32string Ufoo;
    ...
    foo  =   "ABC"s;     assert( foo ==   "ABC");   assert( foo == barefootc::basic_string<char>   (  "ABC"));
    foo  = u8"ABC"s;     assert( foo == u8"ABC");   assert( foo == barefootc::basic_string<char>   (u8"ABC"));
