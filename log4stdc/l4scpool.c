...
static int
compare_pool(const struct mempool *obj, const struct mempool *other);
static size_t
...
static void *
stdc_pool_malloc(struct mempool *pool, size_t size, const char *file, int line,
                 const char *func);
static void *
...
stdc_pool_realloc(struct mempool *pool, void *ptr, size_t size,
                  const char *file, int line, const char *func);
static void
stdc_pool_free(struct mempool *pool, void *ptr, const char *file, int line,
               const char *func);
static void
...
init_pool(void *buf, size_t bufsize, struct mempool *pool)
{
    ...
    BFC_INIT_PROLOGUE(bfc_mempool_class_ptr_t, struct stdc_mempool *, stdcpool,
                      buf, bufsize, pool, &l4sc_stdc_mempool_class);
    p->refc = 20000;
    p->file = __FILE__;
    p->line = __LINE__;
    p->func = "init_pool";
