...
int main()
{
    ...
    test(S(L"12345"), L"", 0, S(L"12345"));
    test(S(L"12345"), L"12345", 5, S(L"1234512345"));
    test(S(L"12345"), L"1234567890", 10, S(L"123451234567890"));

    test(S(L"12345678901234567890"), L"", 0, S(L"12345678901234567890"));
    test(S(L"12345678901234567890"), L"12345", 5, S(L"1234567890123456789012345"));
