...
extern const struct bfc_classhdr bfc_cp1252_traits_class;
...
const struct bfc_string_class bfc_shared_cp1252_string_class = {
	.super 		= &bfc_shared_string_class,
	.name 		= "shared_cp1252_string",
	.init 		= bfc_init_empty_cp1252_string,
	...
	.traits		= (void *) &bfc_cp1252_traits_class,

	.substr		= bfc_shared_cp1252_substr,
	.mutable_substr	= mutable_substr,
	.buffered_substr= bfc_buffered_cp1252_substr,
};

const struct bfc_string_class bfc_buffered_cp1252_string_class = {
	.super 		= &bfc_string_class,
	.name 		= "buffered_cp1252_string",
	.init 		= bfc_init_empty_cp1252_string,
...
int
bfc_init_empty_cp1252_string(void *buf, size_t bufsize,
				  struct mempool *pool)
{
	...
	BFC_STRING_INIT_PROLOGUE(bfc_string_classptr_t,
			  ...
			  &bfc_shared_cp1252_string_class);
...
int
bfc_init_shared_cp1252_string(void *buf, size_t bufsize,
...
int
bfc_init_shared_cp1252_string_c_str(void *buf,size_t bufsize,const char *s)
{
	int n;
	l4sc_logger_ptr_t logger = l4sc_get_logger(BFC_STRING_LOGGER);
	...
	n = (*bfc_shared_cp1252_string_class.traits->szlen)(s);
	return bfc_init_shared_cp1252_string(buf, bufsize, s, n);
}

int
bfc_init_buffered_cp1252_string(void *buf, size_t bufsize,
				    const char *s, size_t n)
{
	l4sc_logger_ptr_t logger = l4sc_get_logger(BFC_STRING_LOGGER);
	...
	BFC_STRING_INIT_PROLOGUE(bfc_string_classptr_t,
			  bfc_strptr_t, obj, buf, bufsize, NULL,
			  &bfc_buffered_cp1252_string_class);
...
int
bfc_shared_cp1252_substr(bfc_cstrptr_t s, size_t pos, size_t n,
						void *buf, size_t bufsize)
{
	...
	return (bfc_init_shared_cp1252_string(buf, bufsize, data, sublen));
}
...
mutable_substr(bfc_cstrptr_t s, size_t pos, size_t n, void *buf, size_t bufsize)
{
	...
	bfc_init_shared_cp1252_string(buf, bufsize, data, sublen);
	return (-ENOSYS);
}

int
bfc_buffered_cp1252_substr(bfc_cstrptr_t s, size_t pos, size_t n,
				void *buf, size_t bufsize,
				void *databuf, size_t dbufsize)
{
	...
	rc = bfc_init_buffered_cp1252_string(buf, bufsize,
						 databuf, dbufsize);
	if (rc >= 0) {
