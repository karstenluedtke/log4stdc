...
void test0()
{
    ...
    test(S(L""), L"abcdeabcdeabcdeabcde", 1, 0, S::npos);
    ...
    test(S(L"abcde"), L"abcde", 1, 1, S::npos);
    test(S(L"abcde"), L"abcde", 1, 2, S::npos);
    test(S(L"abcde"), L"abcde", 1, 4, S::npos);
    test(S(L"abcde"), L"abcde", 1, 5, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 1, 0, 1);
    test(S(L"abcde"), L"abcdeabcde", 1, 1, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 1, 5, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 1, 9, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 1, 10, S::npos);
    test(S(L"abcde"), L"abcdeabcdeabcdeabcde", 1, 0, 1);
    test(S(L"abcde"), L"abcdeabcdeabcdeabcde", 1, 1, S::npos);
    ...
    test(S(L"abcde"), L"abcde", 2, 1, S::npos);
    test(S(L"abcde"), L"abcde", 2, 2, S::npos);
    test(S(L"abcde"), L"abcde", 2, 4, S::npos);
    test(S(L"abcde"), L"abcde", 2, 5, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 2, 0, 2);
    test(S(L"abcde"), L"abcdeabcde", 2, 1, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 2, 5, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 2, 9, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 2, 10, S::npos);
    test(S(L"abcde"), L"abcdeabcdeabcdeabcde", 2, 0, 2);
    test(S(L"abcde"), L"abcdeabcdeabcdeabcde", 2, 1, S::npos);
    ...
    test(S(L"abcde"), L"abcde", 4, 1, S::npos);
    test(S(L"abcde"), L"abcde", 4, 2, S::npos);
    test(S(L"abcde"), L"abcde", 4, 4, S::npos);
    test(S(L"abcde"), L"abcde", 4, 5, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 4, 0, 4);
    test(S(L"abcde"), L"abcdeabcde", 4, 1, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 4, 5, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 4, 9, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 4, 10, S::npos);
    test(S(L"abcde"), L"abcdeabcdeabcdeabcde", 4, 0, 4);
    test(S(L"abcde"), L"abcdeabcdeabcdeabcde", 4, 1, S::npos);
    ...
    test(S(L"abcde"), L"abcde", 5, 1, S::npos);
    test(S(L"abcde"), L"abcde", 5, 2, S::npos);
}

template <class S>
void test1()
{
    test(S(L"abcde"), L"abcde", 5, 4, S::npos);
    test(S(L"abcde"), L"abcde", 5, 5, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 5, 0, 5);
    test(S(L"abcde"), L"abcdeabcde", 5, 1, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 5, 5, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 5, 9, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 5, 10, S::npos);
    test(S(L"abcde"), L"abcdeabcdeabcdeabcde", 5, 0, 5);
    test(S(L"abcde"), L"abcdeabcdeabcdeabcde", 5, 1, S::npos);
    ...
    test(S(L"abcde"), L"", 6, 0, S::npos);
    test(S(L"abcde"), L"abcde", 6, 0, S::npos);
    test(S(L"abcde"), L"abcde", 6, 1, S::npos);
    test(S(L"abcde"), L"abcde", 6, 2, S::npos);
    test(S(L"abcde"), L"abcde", 6, 4, S::npos);
    test(S(L"abcde"), L"abcde", 6, 5, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 6, 0, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 6, 1, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 6, 5, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 6, 9, S::npos);
    test(S(L"abcde"), L"abcdeabcde", 6, 10, S::npos);
    test(S(L"abcde"), L"abcdeabcdeabcdeabcde", 6, 0, S::npos);
    test(S(L"abcde"), L"abcdeabcdeabcdeabcde", 6, 1, S::npos);
    ...
    test(S(L"abcdeabcde"), L"abcde", 1, 1, 5);
    test(S(L"abcdeabcde"), L"abcde", 1, 2, 5);
    test(S(L"abcdeabcde"), L"abcde", 1, 4, 5);
    test(S(L"abcdeabcde"), L"abcde", 1, 5, 5);
    test(S(L"abcdeabcde"), L"abcdeabcde", 1, 0, 1);
    test(S(L"abcdeabcde"), L"abcdeabcde", 1, 1, 5);
    test(S(L"abcdeabcde"), L"abcdeabcde", 1, 5, 5);
    test(S(L"abcdeabcde"), L"abcdeabcde", 1, 9, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 1, 10, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 1, 0, 1);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 1, 1, 5);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 1, 10, S::npos);
    ...
    test(S(L"abcdeabcde"), L"abcdeabcde", 5, 9, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 5, 10, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 5, 0, 5);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 5, 1, 5);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 5, 10, S::npos);
    ...
    test(S(L"abcdeabcde"), L"abcde", 9, 1, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 9, 2, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 9, 4, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 9, 5, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 9, 0, 9);
    test(S(L"abcdeabcde"), L"abcdeabcde", 9, 1, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 9, 5, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 9, 9, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 9, 10, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 9, 0, 9);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 9, 1, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 9, 10, S::npos);
    ...
    test(S(L"abcdeabcde"), L"abcde", 10, 1, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 10, 2, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 10, 4, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 10, 5, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 10, 0, 10);
    test(S(L"abcdeabcde"), L"abcdeabcde", 10, 1, S::npos);
}

template <class S>
void test2()
{
    test(S(L"abcdeabcde"), L"abcdeabcde", 10, 5, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 10, 9, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 10, 10, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 10, 0, 10);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 10, 1, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 10, 10, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 10, 19, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 10, 20, S::npos);
    test(S(L"abcdeabcde"), L"", 11, 0, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 11, 0, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 11, 1, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 11, 2, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 11, 4, S::npos);
    test(S(L"abcdeabcde"), L"abcde", 11, 5, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 11, 0, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 11, 1, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 11, 5, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 11, 9, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcde", 11, 10, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 11, 0, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 11, 1, S::npos);
    test(S(L"abcdeabcde"), L"abcdeabcdeabcdeabcde", 11, 10, S::npos);
    ...
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 1, 1, 5);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 1, 2, 5);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 1, 4, 5);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 1, 5, 5);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 1, 0, 1);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 1, 1, 5);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 1, 5, 5);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 1, 9, 5);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 1, 10, 5);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 1, 0, 1);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 1, 1, 5);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 1, 10, 5);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 1, 19, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 1, 20, S::npos);
    ...
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 10, 19, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 10, 20, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"", 19, 0, 19);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 19, 0, 19);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 19, 1, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 19, 2, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 19, 4, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 19, 5, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 19, 0, 19);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 19, 1, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 19, 5, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 19, 9, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 19, 10, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 19, 0, 19);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 19, 1, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 19, 10, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 19, 19, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 19, 20, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"", 20, 0, 20);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 20, 0, 20);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 20, 1, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 20, 2, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 20, 4, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 20, 5, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 20, 0, 20);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 20, 1, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 20, 5, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 20, 9, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 20, 10, S::npos);
...
void test3()
{
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 20, 1, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 20, 10, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 20, 19, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 20, 20, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"", 21, 0, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 21, 0, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 21, 1, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 21, 2, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 21, 4, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcde", 21, 5, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 21, 0, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 21, 1, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 21, 5, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 21, 9, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcde", 21, 10, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 21, 0, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 21, 1, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 21, 10, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 21, 19, S::npos);
    test(S(L"abcdeabcdeabcdeabcde"), L"abcdeabcdeabcdeabcde", 21, 20, S::npos);
}
