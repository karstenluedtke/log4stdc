...
struct l4sc_logger_class {
    BFC_OBJECT_CLASSHDR(l4sc_logger_class_ptr_t, l4sc_logger_ptr_t,
                        l4sc_logger_cptr_t)
    LOGOBJ_METHODS(l4sc_logger_ptr_t, l4sc_logger_cptr_t)
    void (*log)(l4sc_logger_ptr_t logger, int level, const char *msg,
                size_t msglen, const char *file, int line, const char *func);
    int (*is_enabled)(l4sc_logger_cptr_t logger, int level, int recurse);
...
struct l4sc_appender_class {
    BFC_OBJECT_CLASSHDR(l4sc_appender_class_ptr_t, l4sc_appender_ptr_t,
                        l4sc_appender_cptr_t)
    LOGOBJ_METHODS(l4sc_appender_ptr_t, l4sc_appender_cptr_t)
    void (*append)(l4sc_appender_ptr_t appender, l4sc_logmessage_cptr_t msg);
    int (*set_layout)(l4sc_appender_ptr_t appender, l4sc_layout_ptr_t layout);
...
struct l4sc_layout_class {
    BFC_OBJECT_CLASSHDR(l4sc_layout_class_ptr_t, l4sc_layout_ptr_t,
                        l4sc_layout_cptr_t)
    LOGOBJ_METHODS(l4sc_layout_ptr_t, l4sc_layout_cptr_t)
    size_t (*format)(l4sc_layout_ptr_t layout, l4sc_logmessage_cptr_t msg,
                     char *buf, size_t bufsize);
    size_t (*header)(l4sc_layout_ptr_t layout, int kind, char *buf,
                     size_t bufsize);
    size_t (*estimate)(l4sc_layout_ptr_t layout, l4sc_logmessage_cptr_t msg);
    void *spare[8];
};
...
struct l4sc_logmessage_class {
    BFC_OBJECT_CLASSHDR(l4sc_logmessage_class_ptr_t, l4sc_logmessage_ptr_t,
                        l4sc_logmessage_cptr_t)
    void *spare[10];
};
...
struct l4sc_configurator_class {
    BFC_OBJECT_CLASSHDR(l4sc_configurator_class_ptr_t, l4sc_configurator_ptr_t,
                        l4sc_configurator_cptr_t)
    LOGOBJ_METHODS(l4sc_configurator_ptr_t, l4sc_configurator_cptr_t)
    int (*configure)(l4sc_configurator_ptr_t configurator, const char *buf,
                     size_t len);
...
unsigned
l4sc_reduce_hashcode(size_t origval, int origlen, int hashlen);
int
...
void
l4sc_logwarn(const char *fmt, ...) __attribute__((format(printf, 1, 2)));
void
l4sc_loginfo(const char *fmt, ...) __attribute__((format(printf, 1, 2)));
void
l4sc_logdebug(const char *fmt, ...) __attribute__((format(printf, 1, 2)));
#else
void
