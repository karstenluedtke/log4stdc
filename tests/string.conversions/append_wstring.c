...
test(const char *s1, const wchar_t *s2, const char *expected)
{
	...
	rc = bfc_string_append_copy(&s, &ws);
...
#define SE(x) x
	...
	test(S1("12345"), S2(""), SE("12345"));
	test(S1("12345"), S2("12345"), SE("1234512345"));
	test(S1("12345"), S2("1234567890"), SE("123451234567890"));
	test(S1("12345"), S2("12345678901234567890"), SE("1234512345678901234567890"));

	test(S1("1234567890"), S2(""), SE("1234567890"));
	test(S1("1234567890"), S2("12345"), SE("123456789012345"));
	test(S1("1234567890"), S2("1234567890"), SE("12345678901234567890"));
	test(S1("1234567890"), S2("12345678901234567890"), SE("123456789012345678901234567890"));

	test(S1("12345678901234567890"), S2(""), SE("12345678901234567890"));
	test(S1("12345678901234567890"), S2("12345"), SE("1234567890123456789012345"));
	test(S1("12345678901234567890"), S2("1234567890"), SE("123456789012345678901234567890"));
