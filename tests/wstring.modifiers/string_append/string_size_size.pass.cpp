...
int main()
{
    ...
    test(S(L"12345"), S(), 0, 0, S(L"12345"));
    test(S(L"12345"), S(L"12345"), 2, 2, S(L"1234534"));
    test(S(L"12345"), S(L"1234567890"), 0, 100, S(L"123451234567890"));

    test(S(L"12345678901234567890"), S(), 0, 0, S(L"12345678901234567890"));
    test(S(L"12345678901234567890"), S(L"12345"), 1, 3, S(L"12345678901234567890234"));
    test(S(L"12345678901234567890"), S(L"12345678901234567890"), 5, 10,
         S(L"123456789012345678906789012345"));
    }
