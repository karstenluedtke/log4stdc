...
LogString RuntimeException::formatMessage(log4cxx_status_t stat) {
	...
	snprintf(buf, sizeof(buf),
		"RuntimeException: return code = %d", (int) stat);
   	LogString s(buf);
	return s;
}
...
LogString IOException::formatMessage(log4cxx_status_t stat) {
	char buf[80];
	snprintf(buf, sizeof(buf),
		"IO Exception : status code = %d", (int) stat);
   	LogString s(buf);
	return s;
}
...
LogString MutexException::formatMessage(log4cxx_status_t stat) {
	char buf[80];
	snprintf(buf, sizeof(buf),
		"Mutex exception: stat = %d", (int) stat);
   	LogString s(buf);
	return s;
}
...
LogString InterruptedException::formatMessage(log4cxx_status_t stat) {
	char buf[80];
	snprintf(buf, sizeof(buf),
		"InterruptedException: stat = %d", (int) stat);
   	LogString s(buf);
	return s;
}
...
LogString ThreadException::formatMessage(log4cxx_status_t stat) {
	char buf[80];
	snprintf(buf, sizeof(buf),
		"Thread exception: stat = %d", (int) stat);
   	LogString s(buf);
	return s;
}
