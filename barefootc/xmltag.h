...
#define BFC_XMLTAGHDR(classptrT) \
	BFC_ITERATORHDR(classptrT, bfc_objptr_t)			\
...
#define BFC_XMLTAG_METHODS(tagptrT,ctagptrT)				\
	...
	int (*get_name)(bfc_ctagptr_t, bfc_objptr_t, size_t);		\
	int (*get_attrs)(bfc_ctagptr_t, bfc_objptr_t, size_t);		\
	int (*get_namespace_prefix)(bfc_ctagptr_t,bfc_objptr_t,size_t);

#define BFC_XMLTAG_CLASS_DEF(classptrT,tagptrT,ctagptrT)		\
	BFC_CONTAINER_CLASSHDR(classptrT,tagptrT,ctagptrT,void)		\
	BFC_ITERATOR_METHODS(tagptrT,ctagptrT,bfc_objptr_t,bfc_cobjptr_t,void)\
...
int bfc_init_xmltag(void *buf,size_t bufsize, bfc_cobjptr_t doc,size_t offset);
...
int bfc_tag_get_name(bfc_ctagptr_t tag, bfc_objptr_t buf, size_t bufsize);
int bfc_tag_get_attrs(bfc_ctagptr_t tag, bfc_objptr_t buf, size_t bufsize);
...
struct bfc_tag_parse_state {
	...
	int (*on_content)  (struct bfc_tag_parse_state *state,
			    bfc_ctagptr_t starttag, bfc_cobjptr_t content);
	int (*on_start_tag)(struct bfc_tag_parse_state *state,
			    bfc_ctagptr_t starttag, bfc_cobjptr_t name,
...
int bfc_parse_xmltags(bfc_cobjptr_t s, struct bfc_tag_parse_state *st);
